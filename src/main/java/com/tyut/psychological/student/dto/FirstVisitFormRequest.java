...
public class FirstVisitFormRequest {
    ...
    @Min(value = 1, message = "睡眠评分最小为1")
    @Max(value = 10, message = "睡眠评分最大为10")
    private Integer sleepScore;
    
    @NotNull(message = "压力评分不能为空")
    @Min(value = 1, message = "压力评分最小为1")
    @Max(value = 10, message = "压力评分最大为10")
